...
export const QUEUE_NAME = 'cloudinary-jobs'
export const DELETE_CLOUDINARY_IMAGE_JOB = 'delete-cloudinary-image'
...
export async function addDeleteCloudinaryImageJob(publicId: string): Promise<void>{
